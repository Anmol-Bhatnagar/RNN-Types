...
def build_notebook():
    ...
    cells.append(nbf.v4.new_markdown_cell(
        ...
        "This project compares 5 Recurrent Neural Network (RNN) architectures implemented in **PyTorch** and accelerated using "
        ...
        "5. **Deep RNN**: Two stacked LSTM layers to learn hierarchical representations.\n\n"
        "### Project Metrics\n"
    ...
    cells.append(nbf.v4.new_code_cell(
        ...
        "from src.models import SimpleRNNModel, LSTMModel, GRUModel, BidirectionalModel, DeepRNNModel\n"
